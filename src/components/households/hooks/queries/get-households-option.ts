...
import { HouseholdSummary } from '@households/types'
import { FullErrorResult } from '@lib/errors/types'
...
async function getHouseholds() {
	...
	return client.get<HouseholdSummary[]>(HOUSEHOLDS_API_PATHS.GET_HOUSEHOLDS).then((res) => res.data)
}
