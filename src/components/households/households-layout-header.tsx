...
import { DropdownMenu, DropdownMenuContent, DropdownMenuGroup, DropdownMenuItem, DropdownMenuTrigger } from '@atoms/dropdown-menu'
		...
		<div className='flex items-center bg-background border-b border-border'>
			<div className={cn('flex flex-1 px-4 mt-1 py-2 justify-between mx-auto', maxWidthContentClass)}>
				<div className='flex items-center gap-4'>
					<Logo text={false} className='shrink-0' imgClassName='w-8 pb-0' />
